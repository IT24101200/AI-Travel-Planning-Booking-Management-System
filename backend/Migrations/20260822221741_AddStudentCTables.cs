...
{
    /// <inheritdoc />
    public partial class AddStudentCTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteFrom = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    RouteTo = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    RouteFromLatitude = table.Column<double>(type: "double precision", nullable: true),
                    RouteFromLongitude = table.Column<double>(type: "double precision", nullable: true),
                    RouteToLatitude = table.Column<double>(type: "double precision", nullable: true),
                    RouteToLongitude = table.Column<double>(type: "double precision", nullable: true),
